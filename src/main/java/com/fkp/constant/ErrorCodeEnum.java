...
public enum ErrorCodeEnum {
    ...
    //保存操作日志错误
    SaveOperationLogError("000100", "Save Operation Log Error!"),

    OperationLogDataError("000101", "Operation Log Data Error!"),

    SaveOperationLogDataBaseError("000102", "Save Operation Log DataBase Error!");
